...
//   let result = '';
//   const startTime = new Date(`2022-${month}-${day}`);
//   const after3month = new Date(`2022-${month}-${day}`).setMonth() + 3;
//   console.log(after3month);
...
checkin과 checkout 배열의 길이는 각각 7 이다. length는 7로 동일-> for문을 1번만 돌리면된다. 혹은 내장 메소드
*/
//입출력 예
...
function solution(inArr, outArr) {
  let result = [];
  let gap = 0;
